 ...
 */
public class CssSetConverter<T> implements CssConverter<ImmutableSequencedSet<T>> {
    /**
    ...
    public CssSetConverter(@NonNull CssConverter<T> elementConverter) {
        this(elementConverter, ", ");
    }

    public CssSetConverter(@NonNull CssConverter<T> elementConverter, @Nullable String delimiter) {
     ...
     */
    public CssSetConverter(@NonNull CssConverter<T> elementConverter, @Nullable String delimiter, @Nullable String prefix, @Nullable String suffix, @Nullable Comparator<T> comparatorForSorting) {
    ...
    public String getHelpText() {
        return "Format of ⟨Set⟩: ⟨Item⟩, ⟨Item⟩, ...\n"
