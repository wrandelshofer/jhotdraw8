...
/// This is a model on which a `CssAST.SelectorGroup` can perform a match
/// operation.
///
...
public interface SelectorModel<T> {
    ...
    ///                         null means no namespace)
    /// @param name             The attribute name
    /// @return The attribute value as a list of [CssToken]s.
    @Nullable
    ...
    ///                  element. That is, `null` has the same effect like the
    ///                  keyword "unset".
