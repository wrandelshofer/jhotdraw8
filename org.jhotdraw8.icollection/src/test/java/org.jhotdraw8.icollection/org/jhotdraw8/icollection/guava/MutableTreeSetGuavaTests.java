...
/// Tests [MutableTreeSet] with the Guava test suite.
public class MutableTreeSetGuavaTests {

    public static Test suite() {
        return new MutableTreeSetGuavaTests().allTests();
    }

    public Test allTests() {
        TestSuite suite = new TestSuite(MutableTreeSet.class.getSimpleName());
        ...
        return SetTestSuiteBuilder.using(
                        new TestStringSetGenerator() {
                            ...
                            public Set<String> create(String[] elements) {
                                return new MutableTreeSet<>(MinimalCollection.of(elements));
                            }
                        })
                .named(MutableTreeSet.class.getSimpleName())
                .withFeatures(
    ...
    public Test testsForReversedSet() {
        return SetTestSuiteBuilder.using(
                        new TestStringSetGenerator() {
                            @Override
                            public Set<String> create(String[] elements) {
                                return new MutableTreeSet<>(MinimalCollection.of(elements)).reversed();
                            }
                        })
                .named(MutableTreeSet.class.getSimpleName() + "Reversed")
                .withFeatures(
                        SetFeature.GENERAL_PURPOSE,
                        CollectionFeature.DESCENDING_VIEW,
                        CollectionFeature.SUBSET_VIEW,
