...
import org.jhotdraw8.icollection.alt.PersistentBMTrieMap;
...
public class PersistentBMTrieMapJmh {
    ...
    private PersistentBMTrieMap<Key, Boolean> mapA;

    @Setup
    public void setup() {
        data = new BenchmarkData(size, mask);
        mapA = PersistentBMTrieMap.of();
    ...
    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mRemoveThenAdd() {
        Key key = data.nextKeyInA();
        return mapA.removing(key).putting(key, Boolean.TRUE);
    }

    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mPut() {
        Key key = data.nextKeyInA();
        return mapA.putting(key, Boolean.FALSE);
    }

    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mCopyOf() {
        return PersistentBMTrieMap.copyOf(data.mapA);
    }

    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mCopyOnyByOne() {
        PersistentBMTrieMap<Key, Boolean> set = PersistentBMTrieMap.of();
    ...
    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mTail() {
        return mapA.removing(mapA.iterator().next().getKey());
    }

    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mRemoveOneByOne() {
        var map = mapA;
    ...
    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mRemoveAll() {
    ...
    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mRetainAllNoneRetained() {
        var set = mapA;
    ...
    @Benchmark
    public PersistentBMTrieMap<Key, Boolean> mRetainAllAllRetained() {
        var set = mapA;
