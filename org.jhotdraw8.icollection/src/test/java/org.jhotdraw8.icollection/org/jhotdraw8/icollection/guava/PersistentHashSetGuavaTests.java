...
/// Tests [PersistentHashSet] with the Guava test suite.
public class PersistentHashSetGuavaTests {

    public static Test suite() {
        return new PersistentHashSetGuavaTests().allTests();
    }

    public Test allTests() {
        TestSuite suite = new TestSuite(PersistentHashSet.class.getSimpleName());
                        ...
                        new TestStringSetGenerator() {
                            ...
                            public Set<String> create(String[] elements) {
                                return new MutableSetFacade<>(
                                        PersistentHashSet.<String>copyOf(MinimalCollection.<String>of(elements)));
                            }
                        })
                .named(PersistentHashSet.class.getSimpleName())
                .withFeatures(
