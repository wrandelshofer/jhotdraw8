...
import org.jhotdraw8.icollection.MutableLinkedHashElementSet;
...
public class MutableLinkedSetJmh {
    ...
    private MutableLinkedHashElementSet<Key> setA;
    private MutableLinkedHashElementSet<Key> setAA;
    private MutableLinkedHashElementSet<Key> setB;

    @Setup
    public void setup() {
        data = new BenchmarkData(size, mask);
        setA = new MutableLinkedHashElementSet<>(data.setA);
        setB = new MutableLinkedHashElementSet<>(data.listB);
        setAA = new MutableLinkedHashElementSet<>(data.listA);
    }

    @Benchmark
    public MutableLinkedHashElementSet<Key> mAdd() {
        MutableLinkedHashElementSet<Key> set = new MutableLinkedHashElementSet<>();
    ...
    @Benchmark
    public MutableLinkedHashElementSet<Key> mCopyOf() {
        MutableLinkedHashElementSet<Key> set = new MutableLinkedHashElementSet<>(data.listA);
        assert set.size() == data.listA.size();
        return set;
    }
    ...
    @Benchmark
    public MutableLinkedHashElementSet<Key> mRemove() {
        MutableLinkedHashElementSet<Key> set = setA.clone();
        for (Key key : data.listA) {
            set.remove(key);
        }
        assert set.isEmpty();
    ...
    @Benchmark
    public MutableLinkedHashElementSet<Key> mRemoveAll() {
        MutableLinkedHashElementSet<Key> set = setA.clone();
    ...
    @Benchmark
    public MutableLinkedHashElementSet<Key> mRemoveAllSameType() {
        MutableLinkedHashElementSet<Key> set = setA.clone();
        set.removeAll(setAA);
        assert set.isEmpty();
        return set;
    ...
    @Benchmark
    public MutableLinkedHashElementSet<Key> mRemoveFirst() {
        var s = setA.clone();
    ...
    @Benchmark
    public MutableLinkedHashElementSet<Key> mRetainAllAllRetained() {
        MutableLinkedHashElementSet<Key> set = setA.clone();
    ...
    @Benchmark
    public MutableLinkedHashElementSet<Key> mRetainAllNoneRetained() {
        MutableLinkedHashElementSet<Key> set = setA.clone();
