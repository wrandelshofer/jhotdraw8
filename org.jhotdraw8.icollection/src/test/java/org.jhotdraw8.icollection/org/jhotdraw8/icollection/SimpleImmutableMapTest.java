...
public class SimpleImmutableMapTest extends AbstractImmutableMapTest {
    @Override
    protected <K, V> @NonNull SimpleImmutableMap<K, V> newInstance() {
    ...
    protected @NonNull <K, V> ImmutableMap<K, V> toClonedInstance(@NonNull ImmutableMap<K, V> m) {
        return SimpleImmutableMap.copyOf(m);
    }
