...
public class ChampMap2Jmh {
    ...
    private ChampMap2<Key, Boolean> mapA;
    ...
    @Benchmark
    public ChampMap2<Key, Boolean> mRemoveThenAdd() {
        Key key = data.nextKeyInA();
        return mapA.remove(key).put(key, Boolean.TRUE);
    }

    @Benchmark
    public ChampMap2<Key, Boolean> mPut() {
        Key key = data.nextKeyInA();
        return mapA.put(key, Boolean.FALSE);
    }

    @Benchmark
    public ChampMap2<Key, Boolean> mCopyOf() {
        return ChampMap2.copyOf(data.mapA);
    }

    @Benchmark
    public ChampMap2<Key, Boolean> mCopyOnyByOne() {
        ChampMap2<Key, Boolean> set = ChampMap2.of();
    ...
    @Benchmark
    public ChampMap2<Key, Boolean> mTail() {
        return mapA.remove(mapA.iterator().next().getKey());
    }

    @Benchmark
    public ChampMap2<Key, Boolean> mRemoveOneByOne() {
        var map = mapA;
    ...
    @Benchmark
    public ChampMap2<Key, Boolean> mRemoveAll() {
    ...
    @Benchmark
    public ChampMap2<Key, Boolean> mRetainAllNoneRetained() {
        var set = mapA;
    ...
    @Benchmark
    public ChampMap2<Key, Boolean> mRetainAllAllRetained() {
        var set = mapA;
