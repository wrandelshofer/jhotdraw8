...
public abstract class AbstractImmutableSortedMapTest extends AbstractImmutableMapTest {
     ...
     */
    protected abstract <K, V> ImmutableSortedMap<K, V> newInstance();


    /**
     * Creates a new instance with the specified map.
     */
    protected abstract <K, V> ImmutableSortedMap<K, V> newInstance(Map<K, V> m);

    protected abstract <K, V> ImmutableSortedMap<K, V> newInstance(ReadOnlyMap<K, V> m);


    protected abstract <K, V> ImmutableSortedMap<K, V> toClonedInstance(ImmutableMap<K, V> m);

    /**
     * Creates a new instance with the specified map.
     */
    protected abstract <K, V> ImmutableSortedMap<K, V> newInstance(Iterable<Map.Entry<K, V>> m);
