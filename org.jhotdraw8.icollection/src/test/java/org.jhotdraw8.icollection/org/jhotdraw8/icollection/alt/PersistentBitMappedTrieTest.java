...
public class PersistentBitMappedTrieTest {
    @Test
    public void shouldAppend() {
        var actual = new MutableBMTrieList<Integer>();
    ...
    public void shouldRemovingOneByOne() {
        // Performance: This is fast because we remove the tree element in each iteration
        var actual = new MutableBMTrieList<Integer>();
        List<Integer> expected = IntStream.range(0, 1_000).boxed().collect(Collectors.toList());
        actual.addAll(expected);
        for (var e : expected) {
            actual.remove(e);
        }
    ...
    public void shouldRemovingOneByOneImmutableShuffled() {
        ...
        var actual = new PersistentBMTrieList<Integer>();
