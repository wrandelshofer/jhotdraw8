...
public class PersistentBMTrieHashSet<E> implements Serializable, PersistentSequencedSet<E> {
    private static final PersistentBMTrieHashSet<?> EMPTY = new PersistentBMTrieHashSet<>(
    ...
    protected PersistentBMTrieHashSet(PrivateData privateData) {
    ...
    protected PersistentBMTrieHashSet<E> newInstance(PrivateData privateData) {
        return new PersistentBMTrieHashSet<>(privateData);
    }

    private PersistentBMTrieHashSet<E> newInstance(BitmapIndexedNode<SequencedElement<E>> root,
                                                   PersistentBMTrieList<Object> vector,
                                                   int size, int offset) {
        return new PersistentBMTrieHashSet<>(new PrivateData(new OpaqueRecord<>(root, vector, size, offset)));
    }

    PersistentBMTrieHashSet(
    ...
    @SuppressWarnings("unchecked")
    public static <E> PersistentBMTrieHashSet<E> of() {
        return ((PersistentBMTrieHashSet<E>) PersistentBMTrieHashSet.EMPTY);
    }
    ...
    public static <E> PersistentBMTrieHashSet<E> of(E @Nullable ... elements) {
        ...
        return PersistentBMTrieHashSet.<E>of().addingAll(Arrays.asList(elements));
    }

    @Override
    public PersistentBMTrieHashSet<E> adding(@Nullable E key) {
        return addLast(key, false);
    }

    @Override
    @SuppressWarnings({"unchecked"})
    public PersistentBMTrieHashSet<E> addingAll(Iterable<? extends E> c) {
        if (isEmpty() && c instanceof PersistentBMTrieHashSet<? extends E> s) {
            return (PersistentBMTrieHashSet<E>) s;
        }
        var m = toMutable();
        return m.addAll(c) ? m.toPersistent() : this;
    }

    public PersistentBMTrieHashSet<E> addingFirst(@Nullable E element) {
        return addFirst(element, true);
    }

    private PersistentBMTrieHashSet<E> addFirst(@Nullable E e, boolean moveToFirst) {
    ...
    private PersistentBMTrieHashSet<E> addLast(@Nullable E e,
                                               boolean moveToLast) {
        var details = new ChangeEvent<SequencedElement<E>>();
    ...
    /// {@inheritDoc}
    @Override
    public PersistentBMTrieHashSet<E> cleared() {
        return of();
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof PersistentBMTrieHashSet<?> that) {
    ...
    @Override
    public PersistentBMTrieHashSet<E> removing(@Nullable E key) {
        ...
        if (details.isModified()) {
            ...
            return size == 1 ? PersistentBMTrieHashSet.of() : renumber(newRoot, result.first(), size - 1,
                    result.second());
        }
        return this;
    }
    ...
    @Override
    public PersistentBMTrieHashSet<E> removingAll(Iterable<?> c) {
        var m = toMutable();
    ...
    @SuppressWarnings("unchecked")
    @Override
    public PersistentBMTrieHashSet<E> removingFirst() {
        return this.removing(getFirst());
    }

    @SuppressWarnings("unchecked")
    @Override
    public PersistentBMTrieHashSet<E> removingLast() {
    ...
    /// @return a new [PersistentBMTrieHashSet] instance
    private PersistentBMTrieHashSet<E> renumber(
            BitmapIndexedNode<SequencedElement<E>> root,
            PersistentBMTrieList<Object> vector,
            int size, int offset) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public PersistentBMTrieHashSet<E> retainingAll(Iterable<?> c) {
        var m = toMutable();
    ...
    @Override
    public MutableBMTrieHashSet<E> toMutable() {
        return new MutableBMTrieHashSet<>(this);
    }
    ...
    private static class SerializationProxy<E> extends SetSerializationProxy<E> {
        ...
        protected Object readResolve() {
            return PersistentBMTrieHashSet.copyOf(deserializedElements);
        }
    }
