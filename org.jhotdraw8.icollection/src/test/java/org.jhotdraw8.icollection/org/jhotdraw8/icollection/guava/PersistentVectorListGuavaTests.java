...
/// Tests [PersistentVectorList] with the Guava test suite.
public class PersistentVectorListGuavaTests {

    public static Test suite() {
        return new PersistentVectorListGuavaTests().allTests();
    }
        ...
        return ListTestSuiteBuilder.using(
                        new TestStringListGenerator() {
                            ...
                            public List<String> create(String[] elements) {
                                return new MutableListFacade<>(PersistentVectorList.copyOf(MinimalCollection.of(elements)));
                            }
                        })
