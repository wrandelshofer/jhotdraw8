...
public class PersistentVectorSetJmh {
    ...
    private PersistentVectorSet<Key> setA;
    private PersistentVectorSet<Key> setAA;
    private PersistentVectorSet<Key> setB;

    @Setup
    public void setup() {
        data = new BenchmarkData(size, mask);
        setA = PersistentVectorSet.copyOf(data.setA);
        setB = PersistentVectorSet.copyOf(data.listB);
        setAA = PersistentVectorSet.copyOf(data.listA);
    }
    ...
    */
    @Benchmark
    public PersistentVectorSet<Key> mRemoveAllFromDifferentType() {
        PersistentVectorSet<Key> set = setA;
        PersistentVectorSet<Key> updated = set.removingAll(data.setA);
        assert updated.isEmpty();
        return updated;
    }

    @Benchmark
    public PersistentVectorSet<Key> mRemoveAllFromSameType() {
        PersistentVectorSet<Key> set = setA;
        PersistentVectorSet<Key> updated = set.removingAll(setAA);
        assert updated.isEmpty();
        return updated;
    }
    ...
    @Benchmark
    public PersistentVectorSet<Key> mRetainAllFromDifferentTypeAllRetained() {
        PersistentVectorSet<Key> set = setA;
        PersistentVectorSet<Key> updated = set.retainingAll(data.setA);
        assert updated == setA;
        return updated;
    }

    @Benchmark
    public PersistentVectorSet<Key> mRetainAllFromDifferentTypeNoneRetained() {
        PersistentVectorSet<Key> set = setA;
        PersistentVectorSet<Key> updated = set.retainingAll(data.setB);
        assert updated.isEmpty();
        return updated;
    }

    @Benchmark
    public PersistentVectorSet<Key> mRetainAllFromSameTypeAllRetained() {
        PersistentVectorSet<Key> set = setA;
        PersistentVectorSet<Key> updated = set.retainingAll(setAA);
        assert updated == setA;
        return updated;
    }
    ...
    @Benchmark
    public PersistentVectorSet<Key> mRetainAllFromSameTypeNoneRetained() {
        PersistentVectorSet<Key> set = setA;
        PersistentVectorSet<Key> updated = set.retainingAll(setB);
        assert updated.isEmpty();
        return updated;
    }
/*
