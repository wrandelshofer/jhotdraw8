...
public class SimpleImmutableSetTest extends AbstractImmutableSetTest {
    ...
    public void testToMutableAddAllWithImmutableTypeAndAllNewKeysShouldReturnTrue(@NonNull SetData data) throws Exception {
        ...
        SimpleMutableSet<Key> mutableInstance = (SimpleMutableSet<Key>) instance.toMutable();
    ...
    public void testOfArrayArgShouldYieldExpectedResult(@NonNull SetData data) throws Exception {
        ImmutableSet<Key> instance = SimpleImmutableSet.of(data.a().toArray(new Key[0]));
