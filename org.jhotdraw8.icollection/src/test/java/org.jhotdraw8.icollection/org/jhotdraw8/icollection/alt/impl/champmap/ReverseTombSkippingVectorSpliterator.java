...
public class ReverseTombSkippingVectorSpliterator<E> extends Spliterators.AbstractSpliterator<E> {
    private final PersistentBMTrieList<Object> vector;
    private final Function<Object, E> mapper;
    private int index;

    public ReverseTombSkippingVectorSpliterator(PersistentBMTrieList<Object> vector, Function<Object, E> mapper, long est, int additionalCharacteristics) {
