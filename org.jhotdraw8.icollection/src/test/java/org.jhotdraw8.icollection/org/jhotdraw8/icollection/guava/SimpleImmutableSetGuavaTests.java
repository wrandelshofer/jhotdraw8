...
/**
 * Tests {@link SimpleImmutableSet} with the Guava test suite.
 */

public class SimpleImmutableSetGuavaTests {

    public static Test suite() {
        return new SimpleImmutableSetGuavaTests().allTests();
    }

    public Test allTests() {
        TestSuite suite = new TestSuite(SimpleImmutableSet.class.getSimpleName());
                        ...
                        new TestStringSetGenerator() {
                            ...
                            public Set<String> create(String[] elements) {
                                return new MutableSetFacade<>(
                                        SimpleImmutableSet.<String>copyOf(MinimalCollection.<String>of(elements)));
                            }
                        })
                .named(SimpleImmutableSet.class.getSimpleName())
                .withFeatures(
