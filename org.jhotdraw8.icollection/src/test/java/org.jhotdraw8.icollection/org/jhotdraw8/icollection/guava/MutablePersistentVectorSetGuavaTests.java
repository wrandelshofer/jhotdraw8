...
/// Tests [MutableVectorSet] with the Guava test suite.
public class MutablePersistentVectorSetGuavaTests {

    public static Test suite() {
        return new MutablePersistentVectorSetGuavaTests().allTests();
    }
