...
/// ScalaVectorJmh.mIterate            100000  avgt    2    128479.456          ns/op
...
/*
    ...
    public Vector<Key> mRemoveAtIndex() throws InvocationTargetException, IllegalAccessException {
        return (Vector<Key>) appendedAllMethod.invoke(listA.take(offset), listA.drop(offset));
    }

    @Benchmark
    public Key mGet() {
        int offset = data.nextIndexInA();
        return listA.apply(offset);
    }
    ...
    public Vector<Key> mSet() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        return (Vector<Key>) updated.invoke(listA, offset, key);
    }
*/
}
