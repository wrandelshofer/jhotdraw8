...
import org.jhotdraw8.icollection.MutableHashMap;
...
/// Tests [MutableHashMap] with the Guava test suite.
public class MutablePersistentHashMapGuavaTests {

    public static Test suite() {
        return new MutablePersistentHashMapGuavaTests().allTests();
    }

    public Test allTests() {
        TestSuite suite = new TestSuite(MutableHashMap.class.getSimpleName());
