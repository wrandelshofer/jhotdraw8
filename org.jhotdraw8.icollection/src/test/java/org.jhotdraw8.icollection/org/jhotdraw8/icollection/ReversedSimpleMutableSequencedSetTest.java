...
public class ReversedSimpleMutableSequencedSetTest extends AbstractSequencedSetTest {
    @Override
    ...
    protected <E> @NonNull SequencedSet<E> newInstance() {
        return new SimpleMutableSequencedSet<E>().reversed();
    }
    ...
    protected <E> @NonNull SequencedSet<E> newInstance(Set<E> m) {
        return new SimpleMutableSequencedSet<>(m).reversed();
    }

    @Override
    protected <E> @NonNull SequencedSet<E> newInstance(ReadOnlySet<E> m) {
        SimpleMutableSequencedSet<E> es = new SimpleMutableSequencedSet<>();
