...
public class ChampMap2<K, V>
        implements ImmutableMap<K, V>, Serializable {
    private static final @NonNull ChampMap2<?, ?> EMPTY = new ChampMap2<>(BitmapIndexedNode.emptyNode(), 0);
    @Serial
    ...
    ChampMap2(@NonNull BitmapIndexedNode<K, V> root, int size) {
        this.root = root;
        this.size = size;
    }
    ...
    public static <K, V> @NonNull ChampMap2<K, V> copyOf(@NonNull Iterable<? extends Map.Entry<? extends K, ? extends V>> c) {
        return ChampMap2.<K, V>of().putAll(c);
    }
     ...
     * @return an immutable copy
     */
    public static <K, V> @NonNull ChampMap2<K, V> copyOf(@NonNull Map<? extends K, ? extends V> map) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K, V> @NonNull ChampMap2<K, V> of() {
        return (ChampMap2<K, V>) ChampMap2.EMPTY;
    }
     ...
     */
    @Override
    public @NonNull ChampMap2<K, V> clear() {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof ChampMap2) {
            ChampMap2<?, ?> that = (ChampMap2<?, ?>) other;
    ...
    @Override
    public @NonNull ChampMap2<K, V> putAll(@NonNull Map<? extends K, ? extends V> m) {
        return (ChampMap2<K, V>) ImmutableMap.super.putAll(m);
    }

    @SuppressWarnings("unchecked")
    @Override
    public @NonNull ChampMap2<K, V> putAll(@NonNull Iterable<? extends Map.Entry<? extends K, ? extends V>> c) {
        var m = toMutable();
        return m.putAll(c) ? m.toImmutable() : this;
    }

    @Override
    public @NonNull ChampMap2<K, V> remove(@NonNull K key) {
        int keyHash = keyHash(key);
        var details = new ChangeEvent<V>();
        var newRootNode = root.remove(null, key, keyHash, 0, details);
        if (details.isModified()) {
            return size == 1 ? ChampMap2.of() : new ChampMap2<>(newRootNode, size - 1);
        }
        return this;
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public @NonNull ChampMap2<K, V> removeAll(@NonNull Iterable<? extends K> c) {
        var m = toMutable();
    ...
    @SuppressWarnings("unchecked")
    @Override
    public @NonNull ChampMap2<K, V> retainAll(@NonNull Iterable<? extends K> c) {
        var m = toMutable();
     ...
     */
    @Override
    public @NonNull MutableChampMap2<K, V> toMutable() {
        return new MutableChampMap2<>(this);
    }

    @Override
    public @NonNull MutableChampMap2<K, V> asMap() {
        return new MutableChampMap2<>(this);
    }
    ...
    static class SerializationProxy<K, V> extends MapSerializationProxy<K, V> {
        ...
        protected @NonNull Object readResolve() {
            return ChampMap2.of().putAll(deserializedEntries);
        }
    }
}