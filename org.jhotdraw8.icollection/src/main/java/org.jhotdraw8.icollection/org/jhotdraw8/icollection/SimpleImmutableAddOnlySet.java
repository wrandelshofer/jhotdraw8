 ...
 */
public abstract class SimpleImmutableAddOnlySet<E> implements ImmutableAddOnlySet<E> {
    ...
    private static <K> @NonNull SimpleImmutableAddOnlySet<K> mergeTwoKeyValPairs(@NonNull K key0, int keyHash0,
        ...
        if (mask0 != mask1) {
            ...
            final SimpleImmutableAddOnlySet<K> node =
    ...
    public static <E> @NonNull SimpleImmutableAddOnlySet<E> of() {
        return (SimpleImmutableAddOnlySet<E>) BitmapIndexedNode.EMPTY_NODE;
    }
    ...
    @SafeVarargs
    public static <E> @NonNull SimpleImmutableAddOnlySet<E> of(E @NonNull ... elements) {
        SimpleImmutableAddOnlySet<E> set = (SimpleImmutableAddOnlySet<E>) BitmapIndexedNode.EMPTY_NODE;
        for (E e : elements) {
            set = set.add(e);
        }
        return set;
    ...
    @Override
    public @NonNull SimpleImmutableAddOnlySet<E> add(@NonNull E key) {
        return updated(key, key.hashCode(), 0);
    }

    abstract @NonNull SimpleImmutableAddOnlySet<E> updated(@NonNull E key, int keyHash, int shift);

    private static final class BitmapIndexedNode<K> extends SimpleImmutableAddOnlySet<K> {
        private static final @NonNull SimpleImmutableAddOnlySet<?> EMPTY_NODE = new BitmapIndexedNode<>(0, 0);
        @NonNull
        final Object[] nodes;
        ...
        @NonNull SimpleImmutableAddOnlySet<K> copyAndInsertValue(int bitpos,
                                                                 @NonNull K key) {
        ...
        @NonNull SimpleImmutableAddOnlySet<K> copyAndMigrateFromInlineToNode(int bitpos, @NonNull SimpleImmutableAddOnlySet<K> node) {
        ...
        @NonNull SimpleImmutableAddOnlySet<K> copyAndSetNode(int bitpos,
                                                             @NonNull SimpleImmutableAddOnlySet<K> newNode) {
        ...
        @SuppressWarnings("unchecked")
        @NonNull SimpleImmutableAddOnlySet<K> getNode(int index) {
            return (SimpleImmutableAddOnlySet<K>) nodes[nodes.length - 1 - index];
        }

        @NonNull SimpleImmutableAddOnlySet<K> nodeAt(int bitpos) {
        ...
        @Override
        @NonNull SimpleImmutableAddOnlySet<K> updated(@NonNull K key, int keyHash,
                                                      int shift) {
            ...
            if ((dataMap & bitpos) != 0) { // in-place value
                ...
                if (Objects.equals(currentKey, key)) {
                    ...
                    final SimpleImmutableAddOnlySet<K> subNodeNew = mergeTwoKeyValPairs(currentKey,
                            currentKey.hashCode(), key, keyHash, shift + BIT_PARTITION_SIZE);
                    return copyAndMigrateFromInlineToNode(bitpos, subNodeNew);
                }
            } else if ((nodeMap & bitpos) != 0) { // node (not value)
                final SimpleImmutableAddOnlySet<K> subNode = nodeAt(bitpos);
                final SimpleImmutableAddOnlySet<K> subNodeNew =
    ...
    private static final class HashCollisionNode<K> extends SimpleImmutableAddOnlySet<K> {
        ...
        @Override
        @NonNull
        SimpleImmutableAddOnlySet<K> updated(@NonNull K key,
