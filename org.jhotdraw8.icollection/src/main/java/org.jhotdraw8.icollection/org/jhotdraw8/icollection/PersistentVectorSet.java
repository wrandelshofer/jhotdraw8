...
public class PersistentVectorSet<E> implements Serializable, PersistentSequencedSet<E> {
    private static final PersistentVectorSet<?> EMPTY = new PersistentVectorSet<>(
    ...
    private PersistentVectorSet<E> newInstance(BitmapIndexedNode<SequencedElement<E>> root,
                                               PersistentVectorList<Object> vector,
                                               int size, int offset) {
        return new PersistentVectorSet<>(root, vector, size, offset);
    }
    ...
    public static <E> PersistentVectorSet<E> copyOf(Iterable<? extends E> c) {
        return new PersistentVectorSetBuilder<E>().addAll(c).build();
    ...
    public static <E> PersistentVectorSet<E> of() {
        return ((PersistentVectorSet<E>) PersistentVectorSet.EMPTY);
    }
    ...
    @SafeVarargs
    public static <E> PersistentVectorSet<E> of(E @Nullable ... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return new PersistentVectorSetBuilder<E>().addArray(elements).build();
    }

    @Override
    public PersistentVectorSet<E> adding(@Nullable E key) {
        return addLast(key, false);
    }

    @Override
    @SuppressWarnings({"unchecked"})
    public PersistentVectorSet<E> addingAll(Iterable<? extends E> c) {
        if (isEmpty() && c instanceof PersistentVectorSet<? extends E> s) {
            return (PersistentVectorSet<E>) s;
        }
        var m = toMutable();
        return m.addAll(c) ? m.toPersistent() : this;
    }

    public PersistentVectorSet<E> addingFirst(@Nullable E element) {
        return addingFirst(element, true);
    }

    private PersistentVectorSet<E> addingFirst(@Nullable E e, boolean moveToFirst) {
    ...
    @Override
    public PersistentVectorSet<E> addingLast(@Nullable E element) {
        return addLast(element, true);
    }

    private PersistentVectorSet<E> addLast(@Nullable E e,
                                           boolean moveToLast) {
        var details = new ChangeEvent<SequencedElement<E>>();
    ...
    /// {@inheritDoc}
    @Override
    public PersistentVectorSet<E> cleared() {
        return PersistentVectorSet.<E>of();
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof PersistentVectorSet<?> that) {
    ...
    @Override
    public PersistentVectorSet<E> removing(@Nullable E key) {
        ...
        if (details.isModified()) {
            ...
            return size == 1 ? PersistentVectorSet.of() : renumber(newRoot, result.tree(), size - 1,
                    result.offset());
        }
        return this;
    }
    ...
    @Override
    public PersistentVectorSet<E> removingAll(Iterable<?> c) {
        var m = toMutable();
    ...
    @SuppressWarnings("unchecked")
    @Override
    public PersistentVectorSet<E> removingFirst() {
        return this.removing(getFirst());
    }

    @SuppressWarnings("unchecked")
    @Override
    public PersistentVectorSet<E> removingLast() {
    ...
    /// @return a new [PersistentVectorSet] instance
    private PersistentVectorSet<E> renumber(
        ...
        if (SequencedData.vecMustRenumber(size, offset, this.vector.size())) {
            ...
            var b = new PersistentVectorSetBuilder<E>(new IdentityObject(), newOffset);
    ...
    @SuppressWarnings("unchecked")
    @Override
    public PersistentVectorSet<E> retainingAll(Iterable<?> c) {
        var m = toMutable();
    ...
    private static class SerializationProxy<E> extends SetSerializationProxy<E> {
        ...
        protected Object readResolve() {
            return PersistentVectorSet.copyOf(deserializedElements);
        }
    }
