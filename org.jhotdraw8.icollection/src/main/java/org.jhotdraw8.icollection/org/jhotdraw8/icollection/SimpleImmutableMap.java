...
public class SimpleImmutableMap<K, V>
        implements ImmutableMap<K, V>, Serializable {
    private static final @NonNull SimpleImmutableMap<?, ?> EMPTY = new SimpleImmutableMap<>(BitmapIndexedNode.emptyNode(), 0);
    @Serial
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K, V> @NonNull SimpleImmutableMap<K, V> copyOf(@NonNull Iterable<? extends Map.Entry<? extends K, ? extends V>> c) {
        return SimpleImmutableMap.<K, V>of().putAll(c);
    }
     ...
     * @return an immutable copy
     */
    public static <K, V> @NonNull SimpleImmutableMap<K, V> copyOf(@NonNull Map<? extends K, ? extends V> map) {
        return SimpleImmutableMap.<K, V>of().putAll(map);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K, V> @NonNull SimpleImmutableMap<K, V> of() {
        return (SimpleImmutableMap<K, V>) SimpleImmutableMap.EMPTY;
    }
     ...
     */
    @Override
    public @NonNull SimpleImmutableMap<K, V> clear() {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof SimpleImmutableMap) {
            SimpleImmutableMap<?, ?> that = (SimpleImmutableMap<?, ?>) other;
    ...
    @Override
    public @NonNull SimpleImmutableMap<K, V> put(@NonNull K key, @Nullable V value) {
    ...
    @Override
    public @NonNull SimpleImmutableMap<K, V> putAll(@NonNull Map<? extends K, ? extends V> m) {
        return (SimpleImmutableMap<K, V>) ImmutableMap.super.putAll(m);
    }

    @SuppressWarnings("unchecked")
    @Override
    public @NonNull SimpleImmutableMap<K, V> putAll(@NonNull Iterable<? extends Map.Entry<? extends K, ? extends V>> c) {
        var m = toMutable();
        return m.putAll(c) ? m.toImmutable() : this;
    }

    @Override
    public @NonNull SimpleImmutableMap<K, V> remove(@NonNull K key) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public @NonNull SimpleImmutableMap<K, V> removeAll(@NonNull Iterable<? extends K> c) {
        var m = toMutable();
    ...
    @SuppressWarnings("unchecked")
    @Override
    public @NonNull SimpleImmutableMap<K, V> retainAll(@NonNull Iterable<? extends K> c) {
        var m = toMutable();
     ...
     */
    @Override
    public @NonNull SimpleMutableMap<K, V> toMutable() {
        return new SimpleMutableMap<>(this);
    }

    @Override
    public @NonNull SimpleMutableMap<K, V> asMap() {
        return new SimpleMutableMap<>(this);
    }
    ...
    static class SerializationProxy<K, V> extends MapSerializationProxy<K, V> {
        ...
        protected @NonNull Object readResolve() {
            return SimpleImmutableMap.of().putAll(deserializedEntries);
        }
    }
}