...
public final class Tree5<A> extends FingerTree<A> {
    @Serial
     ...
     *
     */
    public Tree5(int size, byte len1, short len12, char len123, int len1234,
                 A[] p1, A[][] p2, A[][][] p3, A[][][][] p4,
                 A[][][][][] d5,
                 A[][][][] s4, A[][][] s3, A[][] s2, A[] s1) {
        this.size = size;
    ...
    public Tree5(int size, A[] p1, A[][] p2, A[][][] p3, A[][][][] p4, A[][][][][] d5, A[][][][] s4, A[][][] s3, A[][] s2, A[] s1) {
        ...
        this(size, (byte) len1, (short) len12, (char) len123, len1234, p1, p2, p3, p4, d5, s4, s3, s2, s1);
    }
