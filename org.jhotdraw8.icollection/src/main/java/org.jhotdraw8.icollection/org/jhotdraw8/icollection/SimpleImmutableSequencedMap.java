...
public class SimpleImmutableSequencedMap<K, V> implements ImmutableSequencedMap<K, V>, Serializable {
    private static final @NonNull SimpleImmutableSequencedMap<?, ?> EMPTY = new SimpleImmutableSequencedMap<>(
     ...
     */
    public static <K, V> @NonNull SimpleImmutableSequencedMap<K, V> copyOf(@NonNull Iterable<? extends Map.Entry<? extends K, ? extends V>> map) {
     ...
     * @return an immutable copy
     */
    public static <K, V> @NonNull SimpleImmutableSequencedMap<K, V> copyOf(@NonNull Map<? extends K, ? extends V> map) {
        return SimpleImmutableSequencedMap.<K, V>of().putAll(map);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K, V> @NonNull SimpleImmutableSequencedMap<K, V> of() {
        return (SimpleImmutableSequencedMap<K, V>) SimpleImmutableSequencedMap.EMPTY;
    }
     ...
     */
    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> clear() {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof SimpleImmutableSequencedMap) {
            SimpleImmutableSequencedMap<?, ?> that = (SimpleImmutableSequencedMap<?, ?>) other;
    ...
    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> put(@NonNull K key, @Nullable V value) {
        return putLast(key, value, false);
    }

    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> putAll(@NonNull Map<? extends K, ? extends V> m) {
        return (SimpleImmutableSequencedMap<K, V>) ImmutableSequencedMap.super.putAll(m);
    }

    @SuppressWarnings("unchecked")
    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> putAll(@NonNull Iterable<? extends Map.Entry<? extends K, ? extends V>> c) {
        var m = toMutable();
        return m.putAll(c) ? m.toImmutable() : this;
    }

    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> putFirst(@NonNull K key, @Nullable V value) {
        return putFirst(key, value, true);
    }

    @NonNull
    private SimpleImmutableSequencedMap<K, V> putFirst(@NonNull K key, @Nullable V value, boolean moveToFirst) {
    ...
    @NonNull
    private SimpleImmutableSequencedMap<K, V> putLast(@NonNull K key, @Nullable V value, boolean moveToLast) {
        var details = new ChangeEvent<SequencedEntry<K, V>>();
    ...
    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> putLast(@NonNull K key, @Nullable V value) {
    ...
    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> remove(@NonNull K key) {
        ...
        if (details.isModified()) {
            ...
            return size == 1 ? SimpleImmutableSequencedMap.of() : renumber(newRoot, result.first(), size - 1, result.second());
        }
        return this;
    }
    ...
    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> removeAll(@NonNull Iterable<? extends K> c) {
        var t = toMutable();
        return t.removeAll(c) ? t.toImmutable() : this;
    }

    @NonNull
    private SimpleImmutableSequencedMap<K, V> renumber(
    ...
    @Override
    public @NonNull SimpleImmutableSequencedMap<K, V> retainAll(@NonNull Iterable<? extends K> c) {
        var m = toMutable();
     ...
     */
    @Override
    public @NonNull SimpleMutableSequencedMap<K, V> toMutable() {
        return new SimpleMutableSequencedMap<>(this);
    }

    @Override
    public @NonNull SimpleMutableSequencedMap<K, V> asMap() {
        return new SimpleMutableSequencedMap<>(this);
    }
    ...
    private static class SerializationProxy<K, V> extends MapSerializationProxy<K, V> {
        ...
        protected @NonNull Object readResolve() {
            return SimpleImmutableSequencedMap.of().putAll(deserializedEntries);
        }
    }
