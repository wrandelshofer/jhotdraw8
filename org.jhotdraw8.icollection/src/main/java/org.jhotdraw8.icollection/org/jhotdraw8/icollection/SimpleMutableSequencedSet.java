/*
 * @(#)SimpleMutableSequencedSet.java
 ...
 * <p>
 * See description at {@link SimpleImmutableSequencedSet}.
 * <p>
 * References:
 * <dl>
...
public class SimpleMutableSequencedSet<E> extends AbstractMutableChampSet<E, SequencedElement<E>> implements ReadOnlySequencedSet<E>,
        SequencedSet<E> {
    @Serial
     ...
     */
    public SimpleMutableSequencedSet() {
    ...
    public SimpleMutableSequencedSet(Iterable<? extends E> c) {
        if (c instanceof SimpleMutableSequencedSet<?>) {
            c = ((SimpleMutableSequencedSet<? extends E>) c).toImmutable();
        }
        if (c instanceof SimpleImmutableSequencedSet<?>) {
            SimpleImmutableSequencedSet<E> that = (SimpleImmutableSequencedSet<E>) c;
            this.root = that.root;
            this.size = that.size;
     ...
     */
    @Override
    public @NonNull SimpleMutableSequencedSet<E> clone() {
        return (SimpleMutableSequencedSet<E>) super.clone();
    }
...
*/
     ...
     */
    public @NonNull SimpleImmutableSequencedSet<E> toImmutable() {
        owner = null;
        return size == 0
                ? SimpleImmutableSequencedSet.of()
                : new SimpleImmutableSequencedSet<>(root, vector, size, offset);
    }
    ...
    private static class SerializationProxy<E> extends SetSerializationProxy<E> {
        ...
        protected @NonNull Object readResolve() {
            return new SimpleMutableSequencedSet<>(deserializedElements);
        }
    }
}