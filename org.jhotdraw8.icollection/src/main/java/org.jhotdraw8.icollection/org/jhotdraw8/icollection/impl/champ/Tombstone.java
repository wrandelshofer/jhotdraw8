...
/// A tombstone is used by [PersistentVectorHashSet] to mark a deleted slot in its Vector.
///
...
///
/// The Scala library. Copyright EPFL and Lightbend, Inc. Apache License 2.0.</dt>
