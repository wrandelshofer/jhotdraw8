...
public class PersistentHashSetWithNodeSubClasses<E> implements PersistentSet<E>, Serializable {
    ...
    private static final PersistentHashSetWithNodeSubClasses<?> EMPTY = new PersistentHashSetWithNodeSubClasses<>(BitmapIndexedNode.emptyNode(), 0);
    @Serial
    ...
    PersistentHashSetWithNodeSubClasses(BitmapIndexedNode<E> root, int size) {
        this.root = root;
        this.size = size;
    }
    ...
    public static <E> PersistentHashSetWithNodeSubClasses<E> copyOf(Iterable<? extends E> c) {
        return PersistentHashSetWithNodeSubClasses.<E>of().addingAll(c);
    }
    ...
    @SuppressWarnings("unchecked")
    public static <E> PersistentHashSetWithNodeSubClasses<E> of() {
        return ((PersistentHashSetWithNodeSubClasses<E>) PersistentHashSetWithNodeSubClasses.EMPTY);
    }
    ...
    @SafeVarargs
    public static <E> PersistentHashSetWithNodeSubClasses<E> of(E @Nullable ... elements) {
        Objects.requireNonNull(elements, "elements is null");
        return new PersistentHashSetBuilderWithNodeSubClasses<E>().addArray(elements).build();
    }
    ...
    @Override
    public PersistentHashSetWithNodeSubClasses<E> adding(@Nullable E element) {
        int keyHash = keyHash(element);
        ChangeEvent<E> details = new ChangeEvent<>();
        BitmapIndexedNode<E> newRootNode = root.put(null, element, keyHash, 0, details,
                PersistentHashSetWithNodeSubClasses::keepOldElement, Objects::equals, PersistentHashSetWithNodeSubClasses::keyHash);
        if (details.isModified()) {
            return new PersistentHashSetWithNodeSubClasses<>(newRootNode, size + 1);
        }
        return this;
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public PersistentHashSetWithNodeSubClasses<E> addingAll(Iterable<? extends E> c) {
        if (isEmpty() && c instanceof PersistentHashSetWithNodeSubClasses<? extends E> s) {
            return (PersistentHashSetWithNodeSubClasses<E>) s;
        }
        var m = toMutable();
    ...
    /// {@inheritDoc}
    @Override
    public PersistentHashSetWithNodeSubClasses<E> cleared() {
        return of();
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof PersistentHashSetWithNodeSubClasses<?> that) {
    ...
    @Override
    public PersistentHashSetWithNodeSubClasses<E> removing(E key) {
        int keyHash = keyHash(key);
        ChangeEvent<E> details = new ChangeEvent<>();
        BitmapIndexedNode<E> newRootNode = root.remove(null, key, keyHash, 0, details, Objects::equals);
        if (details.isModified()) {
            return size == 1 ? PersistentHashSetWithNodeSubClasses.of() : new PersistentHashSetWithNodeSubClasses<>(newRootNode, size - 1);
        }
        return this;
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public PersistentHashSetWithNodeSubClasses<E> removingAll(Iterable<?> c) {
        var m = toMutable();
    ...
    @SuppressWarnings("unchecked")
    @Override
    public PersistentHashSetWithNodeSubClasses<E> retainingAll(Iterable<?> c) {
        var m = toMutable();
    ...
    @Override
    public MutableHashSetWithNodeSubClasses<E> toMutable() {
        return new MutableHashSetWithNodeSubClasses<>(this);
    }
    ...
    private static class SerializationProxy<E> extends SetSerializationProxy<E> {
        ...
        protected Object readResolve() {
            return PersistentHashSetWithNodeSubClasses.copyOf(deserializedElements);
        }
    }
}