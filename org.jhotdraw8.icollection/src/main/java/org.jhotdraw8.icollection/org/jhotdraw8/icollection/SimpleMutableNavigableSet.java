...
public class SimpleMutableNavigableSet<E> extends AbstractSet<E> implements NavigableSet<E>, Serializable, Cloneable, ReadOnlyNavigableSet<E> {
     ...
     */
    public SimpleMutableNavigableSet(@Nullable Comparator<E> comparator) {
     ...
     */
    public SimpleMutableNavigableSet(@Nullable Comparator<E> comparator, Collection<? extends E> c) {
        this.comparator = comparator == null ? NaturalComparator.instance() : comparator;
        this.root = RedBlackTree.empty();
        this.addAll(c);
    }
     ...
     */
    public SimpleMutableNavigableSet() {
     ...
     * @param c the collection
     */
    public SimpleMutableNavigableSet(Iterable<? extends E> c) {
        this.comparator = NaturalComparator.instance();
        this.root = RedBlackTree.empty();
        this.addAll(c);
    }

    SimpleMutableNavigableSet(@Nullable Comparator<E> comparator, RedBlackTree<E, Void> root) {
        this.comparator = comparator == null ? NaturalComparator.instance() : comparator;
        this.root = root;
    }
     ...
     */
    public @NonNull SimpleImmutableNavigableSet<E> toImmutable() {
