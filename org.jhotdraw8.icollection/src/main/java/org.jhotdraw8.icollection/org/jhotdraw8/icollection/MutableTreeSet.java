...
public class MutableTreeSet<E> extends AbstractSet<E> implements NavigableSet<E>, Serializable, Cloneable, ReadableNavigableSet<E> {
    @Serial
    ...
    public MutableTreeSet(@Nullable Comparator<E> comparator) {
    ...
    public MutableTreeSet(@Nullable Comparator<E> comparator, Collection<? extends E> c) {
        this.comparator = comparator == null ? NaturalComparator.instance() : comparator;
        this.root = RedBlackTree.empty();
        this.addAll(c);
    }
    ...
    MutableTreeSet(@Nullable Comparator<E> comparator, RedBlackTree<E, Void> root) {
        this.comparator = comparator == null ? NaturalComparator.instance() : comparator;
        this.root = root;
    }
    ...
    public MutableTreeSet<E> clone() {
        try {
            return (MutableTreeSet<E>) super.clone();
    ...
    private Object writeReplace() {
        return new MutableTreeSet.SerializationProxy<>(this);
    }
    ...
    private static class SerializationProxy<E> extends SortedSetSerializationProxy<E> {
        ...
        protected Object readResolve() {
            return new MutableTreeSet<>(deserializedComparator, deserializedElements);
        }
    }
