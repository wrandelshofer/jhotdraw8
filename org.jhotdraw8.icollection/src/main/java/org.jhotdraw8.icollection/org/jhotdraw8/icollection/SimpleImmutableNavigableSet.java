 ...
 */
public class SimpleImmutableNavigableSet<E> implements ImmutableNavigableSet<E>, Serializable {
    @Serial
    ...
    protected SimpleImmutableNavigableSet(@NonNull PrivateData privateData) {
     ...
     */
    protected @NonNull SimpleImmutableNavigableSet<E> newInstance(@NonNull PrivateData privateData) {
        return new SimpleImmutableNavigableSet<>(privateData);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <E> @NonNull SimpleImmutableNavigableSet<E> copyOf(@Nullable Comparator<E> comparator, @NonNull Iterable<? extends E> c) {
        if (comparator == null) comparator = NaturalComparator.instance();
        if (c instanceof SimpleImmutableNavigableSet<? extends E> r && r.comparator.equals(comparator)) {
            return (SimpleImmutableNavigableSet<E>) r;
        }
        if (c instanceof SimpleMutableNavigableSet<? extends E> r && r.comparator.equals(comparator)) {
            return (SimpleImmutableNavigableSet<E>) r.toImmutable();
        }
        return SimpleImmutableNavigableSet.sortedOf(comparator).addAll(c);
    }
     ...
     * @return an immutable set of the provided elements
     */
    public static <E> @NonNull SimpleImmutableNavigableSet<E> copyOf(@NonNull Iterable<? extends E> c) {
        return SimpleImmutableNavigableSet.copyOf(NaturalComparator.instance(), c);
    }
     ...
     */
    public static <E> @NonNull SimpleImmutableNavigableSet<E> sortedOf(@Nullable Comparator<E> comparator) {
        if (comparator == null) comparator = NaturalComparator.instance();
        return new SimpleImmutableNavigableSet<>(comparator, RedBlackTree.of(comparator));
    }
    ...
    @SafeVarargs
    public static <E> @NonNull SimpleImmutableNavigableSet<E> sortedOf(@Nullable Comparator<E> comparator, @NonNull E @Nullable ... elements) {
        Objects.requireNonNull(elements, "elements is null");
        if (comparator == null) comparator = NaturalComparator.instance();
        return SimpleImmutableNavigableSet.sortedOf(comparator).addAll(Arrays.asList(elements));
    }
     ...
     * @return an empty immutable set
     */
    public static <E> @NonNull SimpleImmutableNavigableSet<E> of() {
        return new SimpleImmutableNavigableSet<>(NaturalComparator.instance(), RedBlackTree.of(NaturalComparator.instance()));
    }
    ...
    @SuppressWarnings({"varargs"})
    @SafeVarargs
    public static <E> @NonNull SimpleImmutableNavigableSet<E> of(@NonNull E @Nullable ... elements) {
    ...
    @Override
    public @NonNull SimpleImmutableNavigableSet<E> removeAll(@NonNull Iterable<?> c) {
        return (SimpleImmutableNavigableSet<E>) ImmutableNavigableSet.super.removeAll(c);
    }

    @Override
    public @NonNull SimpleImmutableNavigableSet<E> retainAll(@NonNull Iterable<?> c) {
        return (SimpleImmutableNavigableSet<E>) ImmutableNavigableSet.super.retainAll(c);
    }
    ...
    @Override
    public @NonNull SimpleMutableNavigableSet<E> toMutable() {
        return new SimpleMutableNavigableSet<>(comparator, root);
    }
    ...
    private @NonNull Object writeReplace() {
        return new SimpleImmutableNavigableSet.SerializationProxy<>(this.toMutable());
    }
    ...
    private static class SerializationProxy<E> extends SortedSetSerializationProxy<E> {
        ...
        protected @NonNull Object readResolve() {
            return SimpleImmutableNavigableSet.copyOf(deserializedComparator, deserializedElements);
        }
    }
}
