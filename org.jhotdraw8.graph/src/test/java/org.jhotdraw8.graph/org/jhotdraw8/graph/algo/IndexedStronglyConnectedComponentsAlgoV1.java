 ...
 * </dl>
 * FIXME This implementation has a quadratic runtime. It should be O(N).
 */
public class IndexedStronglyConnectedComponentsAlgoV1 {

    public IndexedStronglyConnectedComponentsAlgoV1() {
    ...
    private static class SCCAlgo {
        ...
        private void dfs(int start) {
            ...
            while (!callStack.isEmpty()) {
                ...
                for (Enumerator.OfInt neighbors = getNeighbors.apply(v); neighbors.moveNext(); ) {
                    arrowVisits++;
