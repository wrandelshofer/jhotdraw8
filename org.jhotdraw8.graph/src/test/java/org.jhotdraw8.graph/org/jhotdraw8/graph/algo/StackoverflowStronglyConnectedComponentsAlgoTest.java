 ...
 */
public class StackoverflowStronglyConnectedComponentsAlgoTest extends AbstractGraphAlgoTest {
    ...
    void testSearchStronglyConnectedComponents(DirectedGraph<String, Integer> graph, List<IntList> expectedSets) {
        ...
        List<List<String>> actualSets = new StackoverflowStronglyConnectedComponentsAlgo().findStronglyConnectedComponents(graph);
