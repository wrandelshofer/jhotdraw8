...
public class IndexedStronglyConnectedComponentsAlgoV1Test {
    ...
    void testSearchStronglyConnectedComponents(DirectedGraph<String, Integer> graph, List<IntList> expectedSets) {
        ...
        List<IntList> actualSets = new IndexedStronglyConnectedComponentsAlgoV1().findStronglyConnectedComponents(intGraph);
