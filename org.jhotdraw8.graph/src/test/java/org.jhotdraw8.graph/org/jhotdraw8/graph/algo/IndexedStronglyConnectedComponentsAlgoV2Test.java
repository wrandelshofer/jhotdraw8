...
/// Tests class [IndexedStronglyConnectedComponentsAlgo].
public class IndexedStronglyConnectedComponentsAlgoV2Test {
    ...
    void testSearchStronglyConnectedComponents(DirectedGraph<String, Integer> graph, List<IntList> expectedSets) {
        ...
        List<IntList> actualSets = new IndexedStronglyConnectedComponentsAlgoV2().findStronglyConnectedComponents(intGraph);
