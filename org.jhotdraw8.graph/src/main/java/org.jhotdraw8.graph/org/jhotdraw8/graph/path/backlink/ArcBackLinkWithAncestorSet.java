...
public class ArcBackLinkWithAncestorSet<V, A> extends AbstractBackLink<ArcBackLinkWithAncestorSet<V, A>> {
     ...
     */
    private @Nullable AddOnlyChampSet<V> ancestors;
    ...
    public ArcBackLinkWithAncestorSet(
            ...
            @NonNull AddOnlyChampSet<V> ancestors) {
        super(parent);
        this.vertex = vertex;
        this.arrow = arrow;
    ...
    public @NonNull AddOnlyChampSet<V> removeAncestors() {
        if (ancestors == null) {
            throw new IllegalStateException("ancestors already removed");
        }
        AddOnlyChampSet<V> ancestors = this.ancestors;
        this.ancestors = null;
        return ancestors;
    }
