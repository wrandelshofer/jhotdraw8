...
public interface ArrowSequenceFinder<V, A, C extends Number & Comparable<C>> {
    ...
    default @Nullable OrderedPair<ImmutableList<A>, C> findArrowSequence(
        ...
        return findArrowSequence(SimpleImmutableList.of(start), goal::equals, maxDepth, costLimit, visited);
    }
    ...
    default @Nullable SimpleOrderedPair<ImmutableList<A>, C> findArrowSequence(
            ...
            int maxDepth,
            @NonNull C costLimit) {
        return findArrowSequence(SimpleImmutableList.of(start), goal::equals, maxDepth, costLimit, new HashSet<>()::add);
    }
    ...
    default @Nullable SimpleOrderedPair<ImmutableList<A>, C> findArrowSequence(
            ...
            @NonNull V goal,
            @NonNull C costLimit) {
        return findArrowSequence(SimpleImmutableList.of(start), goal::equals, Integer.MAX_VALUE, costLimit, new HashSet<>()::add);
    }
    ...
    static <VV, AA, CC extends Number & Comparable<CC>> @Nullable SimpleOrderedPair<ImmutableList<AA>, CC> findArrowSequenceOverWaypoints(
        ...
        if (count == 1) {
            ...
            return new SimpleOrderedPair<>(SimpleImmutableList.of(), zero);
        }
