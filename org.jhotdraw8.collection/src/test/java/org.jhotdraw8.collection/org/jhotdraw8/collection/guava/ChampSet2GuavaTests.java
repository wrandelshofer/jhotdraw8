...
/**
 * Tests {@link ChampSet2} with the Guava test suite.
 */

public class ChampSet2GuavaTests {

    public static Test suite() {
        return new ChampSet2GuavaTests().allTests();
    }

    public Test allTests() {
        TestSuite suite = new TestSuite(ChampSet2.class.getSimpleName());
                        ...
                        new TestStringSetGenerator() {
                            ...
                            public Set<String> create(String[] elements) {
                                return new MutableSetFacade<>(
                                        ChampSet2.<String>copyOf(MinimalCollection.<String>of(elements)));
                            }
                        })
                .named(ChampSet2.class.getSimpleName())
                .withFeatures(
