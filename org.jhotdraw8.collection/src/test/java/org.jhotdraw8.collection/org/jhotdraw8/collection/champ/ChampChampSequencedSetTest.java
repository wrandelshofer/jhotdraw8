...
public class ChampChampSequencedSetTest extends AbstractSequencedSetTest {
    @Override
    protected <E> @NonNull SequencedSet<E> newInstance() {
        return new ChampChampSequencedSet<>();
    }
    ...
    protected <E> @NonNull SequencedSet<E> newInstance(Set<E> m) {
        return new ChampChampSequencedSet<>(m);
    }
    ...
    protected <E> @NonNull ImmutableSequencedSet<E> toImmutableInstance(Set<E> m) {
        return new ChampChampSequencedSet<>(m).toImmutable();
    }

    @Override
    protected <E> @NonNull SequencedSet<E> toClonedInstance(Set<E> m) {
        return ((ChampChampSequencedSet<E>) m).clone();
    }
