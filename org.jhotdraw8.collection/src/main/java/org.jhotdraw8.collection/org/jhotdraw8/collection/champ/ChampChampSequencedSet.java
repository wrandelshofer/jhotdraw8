...
public class ChampChampSequencedSet<E> extends AbstractChampSet<E, SequencedElement<E>> implements ReadOnlySequencedSet<E>,
        SequencedSet<E> {
    ...
    public ChampChampSequencedSet(Iterable<? extends E> c) {
        if (c instanceof ChampChampSequencedSet<?>) {
            c = ((ChampChampSequencedSet<? extends E>) c).toImmutable();
        }
        if (c instanceof ChampChampImmutableSequencedSet<?>) {
            ChampChampImmutableSequencedSet<E> that = (ChampChampImmutableSequencedSet<E>) c;
            this.root = that;
            this.size = that.size;
     ...
     */
    @Override
    public @NonNull ChampChampSequencedSet<E> clone() {
        return (ChampChampSequencedSet<E>) super.clone();
    }
