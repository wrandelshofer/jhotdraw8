...
public class ListXmlConverterTest {
    ...
    public void testToString(@Nullable List<Double> value, String expected) throws Exception {
        ...
        ListXmlConverter<Double> instance = new ListXmlConverter<>(new DoubleCssConverter(false), null);
    ...
    public void testDoubleFromString(List<Double> expected, @NonNull String string) throws Exception {
        ...
        IdFactory idFactory = null;
        ListXmlConverter<Double> instance = new ListXmlConverter<>(new DoubleCssConverter(false));
    ...
    public @NonNull List<DynamicTest> dynamicTestsDoubleFromString() {
        return Arrays.asList(
                ...
                dynamicTest("21", () -> testDoubleFromString(Arrays.asList(1.0, 2.0, 3.0, 4.0), "1, 2, 3; 4")),
                dynamicTest("22", () -> testDoubleFromString(Arrays.asList(1.0, 2.0, 3.0, 4.0), "1, 2, 3) 4")),
                dynamicTest("23", () -> testDoubleFromString(Arrays.asList(1.0, 2.0, 3.0, 4.0), "1, 2, 3} 4")),
                dynamicTest("24", () -> testDoubleFromString(Arrays.asList(1.0, 2.0, 3.0, 4.0), "1, 2, 3] 4"))
        );
    }
