...
package org.jhotdraw8.immutable_collection.guava;
...
import org.jhotdraw8.immutable_collection.facade.MutableSetFacade;
                        ...
                        new TestStringSetGenerator() {
                            ...
                            public Set<String> create(String[] elements) {
                                return new MutableSetFacade<>(
                                        ChampSet.<String>copyOf(MinimalCollection.<String>of(elements)));
                            }
                        })
