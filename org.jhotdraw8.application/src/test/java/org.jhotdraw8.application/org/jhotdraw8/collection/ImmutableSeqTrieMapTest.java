...
public class ImmutableSeqTrieMapTest extends AbstractPersistentSequencedMapTest {
    ...
    protected @NonNull ImmutableMap<HashCollider, HashCollider> of(Map.@NonNull Entry<HashCollider, HashCollider>... entries) {
        return ImmutableSeqTrieMap.<HashCollider, HashCollider>of().copyPutAll(Arrays.asList(entries));
    }
    ...
    protected @NonNull ImmutableMap<HashCollider, HashCollider> copyOf(@NonNull Map<? extends HashCollider, ? extends HashCollider> map) {
        return ImmutableSeqTrieMap.<HashCollider, HashCollider>of().copyPutAll(map);
    }
    ...
    protected @NonNull ImmutableMap<HashCollider, HashCollider> copyOf(@NonNull Iterable<? extends Map.Entry<? extends HashCollider, ? extends HashCollider>> entries) {
        return ImmutableSeqTrieMap.<HashCollider, HashCollider>of().copyPutAll(entries);
    }

    @Test
    @Ignore("manual test")
    public void testDumpStructure() {
        ImmutableSeqTrieMap<HashCollider, String> instance = ImmutableSeqTrieMap.of();
