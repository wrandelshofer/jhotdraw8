 ...
 */
public class ObservableSetFacadeFacade<E> extends SetFacade<E> implements ObservableSet<E> {
    public ObservableSetFacadeFacade(@NonNull ReadOnlySet<E> backingSet) {
        super(backingSet);
    }
