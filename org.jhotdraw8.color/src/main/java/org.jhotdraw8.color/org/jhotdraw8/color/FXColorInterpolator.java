...
public class FXColorInterpolator {
     ...
     */
    public FXColorInterpolator(ColorSpace cs, float[] fromColor, float[] toColor) {
     ...
     */
    public FXColorInterpolator(ColorSpace cs, float[] fromColor, float[] toColor, int hueComponent) {
        this.cs = cs;
