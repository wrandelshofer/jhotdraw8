...
/**
 * Color converter for HSLuv color space.
 * <p>
 * References:
 * <dl>
 *     <dt>HSLuv Reference Implementation, Copyright (c) 2016 Alexei Boronine,
 *     MIT License</dt>
 *     <dd><a href="https://github.com/hsluv/hsluv-java">github.com</a></dd>
 * </dl>
 */
class HlsuvColorConverter {
    ...
    public static double[] hlsuvToLch(double[] tuple) {
        double H = tuple[0];
        double L = tuple[1];
        double S = tuple[2];
    ...
    public static double[] lchToHlsuv(double[] tuple) {
        double L = tuple[0];
        double C = tuple[1];
        double H = tuple[2];

        if (L > 99.9999999) {
            return new double[]{H, 100, 0};
        }
    ...
    public static double[] hlsuvToRgb(double[] tuple) {
        return lchToRgb(hlsuvToLch(tuple));
    }

    public static double[] rgbToHlsuv(double[] tuple) {
        return lchToHlsuv(rgbToLch(tuple));
    }
