...
public class SimplePathMetricsTest {
    ...
    public List<DynamicTest> dynamicTestsShouldBuildSubPathAtArcLength() {
        return Arrays.asList(
                ...
                dynamicTest("quadTo-moveTo-lineTo-cut-end-before-moveTo", () -> shouldIterateSubPath("M435,195 Q450,110,490,110 M530,110 592,195", 0, 100, "M435,195 Q448.20371138917096,120.17896879469777,480.77831105040013,111.2189577143933")),
                ...
                dynamicTest("moveTo-degenerate-crop-at-start", () -> shouldIterateSubPath("M0,0", 0.0, 0.0, "M0,0")),
                dynamicTest("horizontal-line-degenerate-crop-at-start", () -> shouldIterateSubPath("M0,0 2,0", 0.0, 0.0, "M0,0 0,0")),
                dynamicTest("horizontal-line-degenerate-crop-at-end", () -> shouldIterateSubPath("M0,0 2,0", 2.0, 2.0, "M2,0 2,0")),
                dynamicTest("horizontal-line-degenerate-crop-at-middle", () -> shouldIterateSubPath("M0,0 2,0", 0.5, 0.5, "M0.5,0 0.5,0")),
                dynamicTest("horizontal-line-cropped-at-start-and-end", () -> shouldIterateSubPath("M0,0 2,0", 0.25, 0.75, "M0.25,0 0.75,0")),
                ...
                dynamicTest("two-horizontal-lines-cropped-at-end-of-offset-last-element", () -> shouldIterateSubPath("M0,0 1,0 2,0", 0, 1, "M0,0 1,0")),
                ...
                dynamicTest("two-horizontal-lines-cropped-at-start-inside-tree-element", () -> shouldIterateSubPath("M0,0 1,0 2,0", 0.25, 2, "M0.25,0 1,0 2,0")),
                dynamicTest("two-horizontal-lines-cropped-at-start-of-offset-element", () -> shouldIterateSubPath("M0,0 1,0 2,0", 1, 2, "M1,0 2,0")),
