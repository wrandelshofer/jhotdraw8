...
public class BezierPathTest {
    @TestFactory
    public List<DynamicTest> dynamicTestsShouldIterate() {
    ...
    private void shouldIterate(String input, @Nullable String expected) throws ParseException {
    ...
    private void shouldEvalFirstAndLast(String input, PointAndDerivative expectedFirst, PointAndDerivative expectedLastInReverse) throws ParseException {
        var path = SvgPaths.buildSvgString(new BezierPathBuilder(), input).build();
