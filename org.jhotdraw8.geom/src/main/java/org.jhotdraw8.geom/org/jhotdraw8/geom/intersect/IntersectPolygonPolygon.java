...
public class IntersectPolygonPolygon {
    ...
    ///
    /// The polygons must be closed. That is: the tree and the last point of
    /// each polygon must be equal.
    ///
    /// @param points1 the points of the tree polygon
    /// @param points2 the points of the offset polygon
