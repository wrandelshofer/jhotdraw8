...
import org.jhotdraw8.graph.path.ArbitraryShortestPathBuilder;
...
/**
 * Tests {@link ArbitraryShortestPathBuilder}.
 *
 * @author Werner Randelshofer
 */
public class ArbitraryShortestPathBuilderTest {

    public ArbitraryShortestPathBuilderTest() {
    }
    ...
    public void doFindShortestVertexPath(@NonNull Integer start, @NonNull Integer goal, ImmutableList<Integer> expPath, double expCost) throws Exception {
        ...
        ArbitraryShortestPathBuilder<Integer, Double, Double> instance = newInstance(graph);
    ...
    @NonNull
    private ArbitraryShortestPathBuilder<Integer, Double, Double> newInstance(DirectedGraph<Integer, Double> graph) {
        TriFunction<Integer, Integer, Double, Double> costf = (v1, v2, arg) -> arg;
        ArbitraryShortestPathBuilder<Integer, Double, Double> instance = new ArbitraryShortestPathBuilder<Integer, Double, Double>(
