...
public class LinearGradientCssConverterTest {
    ...
    public List<DynamicTest> dynamicTestsFromString() {
        return Arrays.asList(
                ...
                dynamicTest("1", () -> testFromString(new CssLinearGradient(0, 0, 0, 1, true, CycleMethod.NO_CYCLE, new CssStop(CssSize.of(0.5), new CssColor("red", Color.RED)), new CssStop(CssSize.of(0.5), new CssColor("transparent", Color.TRANSPARENT))), "linear-gradient(red 50%, transparent 50% )")),
                dynamicTest("1", () -> testFromString(new CssLinearGradient(0, 0, 1.14, 1.14, false, CycleMethod.REPEAT, new CssStop(CssSize.of(0.5), new CssColor("red", Color.RED)), new CssStop(CssSize.of(0.5), new CssColor("transparent", Color.TRANSPARENT))), "linear-gradient(from 0 0 to 1.14 1.14, repeat,red 50%, transparent 50% )")),
                ...
                dynamicTest("1", () -> testFromString(new CssLinearGradient(0, 0, 10, 0, false, CycleMethod.REFLECT, new CssStop(CssSize.of(0.1), new CssColor("red", Color.RED)), new CssStop(CssSize.of(0.2), new CssColor("white", Color.WHITE))), "linear-gradient(from 0 0 to 10 0, reflect, red 10%, white 20%)")),
    ...
    public List<DynamicTest> dynamicTestsToString() {
        return Arrays.asList(
                ...
                dynamicTest("1", () -> testToString(new CssLinearGradient(0, 0, 0, 1, true, CycleMethod.NO_CYCLE, new CssStop(CssSize.of(0.5), new CssColor("red", Color.RED)), new CssStop(CssSize.of(0.5), new CssColor("transparent", Color.TRANSPARENT))), "linear-gradient(red 50%, transparent 50%)")),
