 ...
 */
public class UniqueBreadthFirstVertexSequenceBuilder<V, A> extends AbstractVertexSequenceBuilder<V> {


    public UniqueBreadthFirstVertexSequenceBuilder(@NonNull Function<V, Iterable<V>> nextNodesFunction) {
        this(Integer.MAX_VALUE, nextNodesFunction);
    }

    public UniqueBreadthFirstVertexSequenceBuilder(int maxLength, @NonNull Function<V, Iterable<V>> nextNodesFunction) {
