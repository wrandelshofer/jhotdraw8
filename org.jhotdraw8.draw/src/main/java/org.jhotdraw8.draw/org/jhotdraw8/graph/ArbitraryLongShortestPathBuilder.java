 ...
 */
public class ArbitraryLongShortestPathBuilder<V, A> extends AbstractLongShortestPathBuilder<V, A> {
    public ArbitraryLongShortestPathBuilder() {
    }

    public ArbitraryLongShortestPathBuilder(@NonNull DirectedGraph<V, A> graph, @NonNull ToLongFunction<A> costf) {
        super(graph, costf);
    }

    public ArbitraryLongShortestPathBuilder(@NonNull DirectedGraph<V, A> graph, @NonNull ToLongTriFunction<V, V, A> costf) {
        super(graph, costf);
    }

    public ArbitraryLongShortestPathBuilder(@NonNull Function<V, Iterable<Arc<V, A>>> nextNodesFunction, @NonNull ToLongFunction<A> costf) {
        super(nextNodesFunction, costf);
    }

    public ArbitraryLongShortestPathBuilder(@NonNull Function<V, Iterable<Arc<V, A>>> nextNodesFunction, @NonNull ToLongTriFunction<V, V, A> costf) {
        super(nextNodesFunction, costf);
    }
    ...
    public static <Vertex> Map.Entry<ImmutableList<Vertex>, Long> findShortestVertexPathLong(
            Set<Vertex> starts,
