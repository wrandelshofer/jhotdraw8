...
public abstract class AbstractLongShortestPathBuilder<V, A> {
     ...
     */
    public @Nullable Map.Entry<ImmutableList<A>, Long> findArrowPath(@NonNull V start, @NonNull V goal) {
     ...
     * @return a VertexPath if traversal is possible
     */
    public @Nullable Map.Entry<ImmutableList<A>, Long> findArrowPath(@NonNull V start, @NonNull Predicate<V> goalPredicate) {
     ...
     * @return a VertexPath if traversal is possible
     */
    public @Nullable Map.Entry<ImmutableList<A>, Long> findArrowPath(@NonNull V start, @NonNull Predicate<V> goalPredicate, long maxCost) {
        BackLink<V, A> node = search(start, goalPredicate, maxCost);
        return toArrowPath(node);
    }

    public static <V, A> Map.@Nullable Entry<ImmutableList<A>, Long> toArrowPath(BackLink<V, A> node) {
        if (node == null) {
            return null;
        }
        //
     ...
     */
    public @Nullable Map.Entry<ImmutableList<A>, Long> findArrowPathOverWaypoints(@NonNull Collection<? extends V> waypoints, long maxCost) {
        List<A> combinedPath = new ArrayList<>();
        V start = null;
        long cost = 0;
        for (V via : waypoints) {
            if (start != null) {
                Map.Entry<ImmutableList<A>, Long> pathWithCost = findArrowPath(start, via::equals, maxCost - cost);
     ...
     * @return a VertexPath if traversal is possible
     */
    public @Nullable Map.Entry<ImmutableList<V>, Long> findVertexPath(@NonNull V start,
    ...
    public static <V, A> Map.@Nullable Entry<ImmutableList<V>, Long> toVertexPath(BackLink<V, A> node) {
        if (node == null) {
            return null;
        }
        //
     ...
     */
    public @Nullable Map.Entry<ImmutableList<V>, Long> findVertexPathOverWaypoints(@NonNull Collection<? extends V> waypoints) {
     ...
     */
    public @Nullable Map.Entry<ImmutableList<V>, Long> findVertexPathOverWaypoints(@NonNull Collection<? extends V> waypoints, long maxCost) {
        List<V> combinedPath = new ArrayList<>();
        V start = null;
        long cost = 0;
        for (V via : waypoints) {
            if (start != null) {
                Map.Entry<ImmutableList<V>, Long> pathWithCost = findVertexPath(start, via::equals, maxCost - cost);
                if (pathWithCost == null) {
                    return null;
                }
