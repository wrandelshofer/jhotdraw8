...
/**
 * This path builder can be used to find an arbitrary shortest path between
 * to vertices in a directed graph.
 * <p>
 * Uses Dijkstra's alorithm for finding a shortest path.
 * <p>
 ...
 */
public class ArbitraryDoubleShortestPathBuilder<V, A> extends AbstractDoubleShortestPathBuilder<V, A> {
    public ArbitraryDoubleShortestPathBuilder() {
    }

    public ArbitraryDoubleShortestPathBuilder(@NonNull DirectedGraph<V, A> graph, @NonNull ToDoubleFunction<A> costf) {
        super(graph, costf);
    }

    public ArbitraryDoubleShortestPathBuilder(@NonNull DirectedGraph<V, A> graph, @NonNull ToDoubleTriFunction<V, V, A> costf) {
        super(graph, costf);
    }

    public ArbitraryDoubleShortestPathBuilder(@NonNull Function<V, Iterable<Arc<V, A>>> nextNodesFunction, @NonNull ToDoubleFunction<A> costf) {
        super(nextNodesFunction, costf);
    }

    public ArbitraryDoubleShortestPathBuilder(@NonNull Function<V, Iterable<Arc<V, A>>> nextNodesFunction, @NonNull ToDoubleTriFunction<V, V, A> costf) {
        super(nextNodesFunction, costf);
    }
    ...
    protected static class MyBackLinkDouble<VV, AA> extends BackLink<VV, AA> {
        ...
        public MyBackLinkDouble(@NonNull VV node, double cost, @Nullable ArbitraryDoubleShortestPathBuilder.MyBackLinkDouble<VV, AA> parent, @Nullable AA arrow) {
            this.vertex = node;
            this.cost = cost;
            this.parent = parent;
            this.arrow = arrow;
