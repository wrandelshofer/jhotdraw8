...
public abstract class AbstractMutableIntBidiGraph implements IntBidiGraph {
    private Node[] nodes = new Node[0];
    private int vertexCount;
    private int arrowCount;

    public AbstractMutableIntBidiGraph() {
    }

    public AbstractMutableIntBidiGraph(int vertexCount) {
        buildAddVertices(vertexCount);
    }

    public AbstractMutableIntBidiGraph(@NonNull IntDirectedGraph g) {
