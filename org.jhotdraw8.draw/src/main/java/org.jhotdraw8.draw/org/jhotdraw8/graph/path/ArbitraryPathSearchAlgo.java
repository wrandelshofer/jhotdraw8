...
class ArbitraryPathSearchAlgo<V, A, C extends Number & Comparable<C>> {
    ...
    protected @Nullable ArcBackLink<V, A, C> search(@NonNull Iterable<V> startVertices,
        ...
        return search(startVertices, goalPredicate, new HashSet<V>()::add, zero, maxCost, nextNodesFunction,
                costFunction, sumFunction);
    }

    private @Nullable ArcBackLink<V, A, C> search(@NonNull Iterable<V> startVertices,
