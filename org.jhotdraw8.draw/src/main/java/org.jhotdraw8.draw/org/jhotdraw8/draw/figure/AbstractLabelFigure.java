 ...
 */
	 ...
	 * @param tn  the text node
	 */
	private void updateTextNodePaint(final @NonNull RenderContext ctx, final @NonNull Text tn) {
	 ...
	 * @param tn  the text node
	 */
	private void updateTextNodeLayout(final @NonNull RenderContext ctx, final @NonNull Text tn) {
