...
public class DefaultFigureFactory extends AbstractFigureFactory {
    ...
    public DefaultFigureFactory(IdFactory idFactory) {
        ...
        addConverter(TransformableFigure.TRANSFORMS, new CssPersistentListConverter<>(new CssTransformConverter(false)));
        addConverter(PolylineFigure.POINTS, new CssPersistentListConverter<>(new Point2DConverter(false)));
