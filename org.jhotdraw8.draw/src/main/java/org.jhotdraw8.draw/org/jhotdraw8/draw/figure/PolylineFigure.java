...
public class PolylineFigure extends AbstractLeafFigure
    ...
    public static final Point2DListStyleableKey POINTS = new Point2DListStyleableKey("points", SimpleImmutableList.of());
    /**
    ...
    public PolylineFigure(double startX, double startY, double endX, double endY) {
        set(POINTS, SimpleImmutableList.of(new Point2D(startX, startY), new Point2D(endX, endY)));
        set(FILL, null);
    }

    public PolylineFigure(Point2D... points) {
        set(POINTS, SimpleImmutableList.of(points));
        set(FILL, null);
    }
    ...
    public void reshapeInLocal(@NonNull Transform transform) {
        ...
        set(POINTS, SimpleImmutableList.copyOf(newP));
    }
