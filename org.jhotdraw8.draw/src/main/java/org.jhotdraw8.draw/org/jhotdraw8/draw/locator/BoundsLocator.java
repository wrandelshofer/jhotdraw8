...
/// <dl>
///     <dt>`relativeX`</dt><dd>Defines a position on the X-axis
///     of the figure, relative to its width.
///     Where `0.0` lies at the left edge of the
///     figure and `1.0` at the right edge.</dd>
///     <dt>`relativeY`</dt><dd>Defines a position on the Y-axis
///     of the figure, relative to its height.
///     Where `0.0` lies at the top edge of the
///     figure and `1.0` at the bottom edge.</dd>
/// </dl>
