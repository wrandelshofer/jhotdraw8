...
public interface StyleableFigure extends Figure {
     ...
     */
    @NonNull
    ObservableWordSetKey STYLE_CLASS = new ObservableWordSetKey("class", ImmutableTrieSet.of());
    /**
     ...
     */
    @NonNull
    ObservableWordSetKey PSEUDO_CLASS = new ObservableWordSetKey("pseudoClass", ImmutableTrieSet.of());
    /**
