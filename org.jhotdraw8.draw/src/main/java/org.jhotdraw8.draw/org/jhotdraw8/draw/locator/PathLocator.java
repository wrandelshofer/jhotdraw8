...
/// <dl>
/// <dt>`relativePath`</dt><dd>Defines a position on the path
/// of the figure, relative to to the length of the path.
/// Where `0.0` lies at the start of the path
/// and `1.0` at the end.</dd>
/// <dt>`offset`</dt><dd>Defines an absolute distance perpendicular
/// to the path at the `relativePath` position.
/// Where `0.0` lies on the path, and a positive value lies
