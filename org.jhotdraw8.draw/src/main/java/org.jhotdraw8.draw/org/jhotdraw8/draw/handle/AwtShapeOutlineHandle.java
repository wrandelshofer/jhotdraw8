 ...
 */
public class AwtShapeOutlineHandle extends AbstractHandle {
    ...
    public AwtShapeOutlineHandle(Figure figure, Shape shape, boolean selectable) {
        super(figure);
        node = new Group();
        path2 = new Path();
        path1 = new Path();
    ...
    public void updateNode(@NonNull DrawingView view) {
        ...
        SvgPaths.buildFromPathIterator(builder, shape.getPathIterator(Shapes.awtTransformFromFX(t)));
