...
public class PolylineOutlineHandle extends AbstractHandle {
    ...
    private final @NonNull Polyline poly1;
    private final @NonNull Polyline poly2;
    ...
    public boolean contains(DrawingView dv, double x, double y, double tolerance) {
        if (FXRectangles.contains(poly2.getBoundsInParent(), x, y, tolerance)) {
            IntersectionResult i = IntersectPathIteratorPoint.intersectPathIteratorPoint(
                    AwtShapes.pointCoordsToPathIterator(poly2.getPoints(), false, PathIterator.WIND_EVEN_ODD, null),
                    x, y, tolerance);
