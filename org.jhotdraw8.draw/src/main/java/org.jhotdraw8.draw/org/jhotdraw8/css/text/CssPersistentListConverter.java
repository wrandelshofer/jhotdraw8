 ...
 */
public class CssPersistentListConverter<T> implements CssConverter<PersistentList<T>> {
    /**
    ...
    public CssPersistentListConverter(CssConverter<T> elementConverter) {
        this(elementConverter, ", ");
    }

    public CssPersistentListConverter(CssConverter<T> elementConverter, String delimiter) {
        this(elementConverter, delimiter, "", "");
    }

    public CssPersistentListConverter(CssConverter<T> elementConverter, String delimiter, String prefix, String suffix) {
     ...
     */
    public CssPersistentListConverter(CssConverter<T> elementConverter, String delimiter, String prefix, String suffix, Comparator<T> comparatorForSorting) {
    ...
    public CssPersistentListConverter(CssConverter<T> elementConverter,
        ...
        this.delimiter = WrappedPersistentList.copyOf(delimiter);
        this.prefix = WrappedPersistentList.copyOf(prefix);
        this.suffix = WrappedPersistentList.copyOf(suffix);
    ...
    public PersistentList<T> parse(@NonNull CssTokenizer tt, @Nullable IdResolver idResolver) throws ParseException, IOException {
        ...
        return WrappedPersistentList.copyOf(list);
    }
